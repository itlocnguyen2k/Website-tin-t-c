        ...
        <header>
            ...
            <nav class="menu">
                <ul>
                    ...
                    <li><span class="border-bottom"></span><a href="{{ url('about') }}">Giới thiệu</a></li>
                    <li><span class="border-bottom"></span><a href="{{ url('contact') }}">Liên hệ</a></li>
                </ul>                                              
            </nav>   
